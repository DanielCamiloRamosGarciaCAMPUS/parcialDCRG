...
public class ControllerWebCoordinador {
	...
	@GetMapping("/estudiante/resultado/{id}")
	public String verResultadoEstudiante(@PathVariable("id") String id, Model model) {
	    ...
	    return "coordinadorResultadoEstudiante"; // 
	}
